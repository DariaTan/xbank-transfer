...
configs/models/cotic.yaml

Output: one parquet file per target date under
<embeds_dir>/<checkpoint_source>_source/cotic/, columns [inn, date,
emb_0..emb_<nb_filters-1>] -- resumable, a date whose file already exists
